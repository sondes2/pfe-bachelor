            ...
            <div class="m-portlet m-portlet--tab">
                ...
                <form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ Route('Users.update', $user->id) }}">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-md-6">
                            <input id="adress" type="text" class="form-control" name="adress" value="{{ $user->adress }}" required>
                        </div>
                    </div>
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-md-6">
                            <input id="specialty" type="text" class="form-control" name="specialty" value="{{ $user->specialty }}" required>
                        </div>
                    </div>
