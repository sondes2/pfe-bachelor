...
<html lang="en">
  ...
  style="background-size: cover;background-image: url({{ asset('images/login/login.png') }})">
    <!-- begin:: Page -->
              ...
              <div class="m-login__wrapper">
                ...
                <div class="m-login__signin">
                  ...
                  <form class="m-login__form m-form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group m-form__group form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <div class="form-group m-form__group form-group{{ $errors->has('password') ? ' has-error' : '' }}">
